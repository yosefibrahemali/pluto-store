                                    ...
                                    <div class="product-img-action-wrap">
                                        ...
                                        <div class="product-action-1" >
                                            {{-- <a aria-label="Quick view" class="action-btn hover-up" data-bs-toggle="modal" data-bs-target="#quickViewModal"> --}}
                                                ...
                                                <form action="{{route('addtowishlistpppp')}}" id="form0002" method="post">
                                                    @csrf
                                            ...
                                            <a onclick="myFunction2()" aria-label="Add To Wishlist" class="action-btn hover-up" >  <i class="fi fi-tr-heart-crack"></i></a>
                                        ...
                                        <div class="product-badges product-badges-position product-badges-mrg">
                                            ...
                                            ?>
                                            @if ($quantity < 5)
                                            <span class="hot" style="background-color: rgba(255, 0, 0, 0.553); color:black;">Only Left {{$product->quantity}}</span>
                                            @else
